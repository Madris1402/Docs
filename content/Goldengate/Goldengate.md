...
4. **Encendemos el Replicat con una condición:** Le decimos al _Replicat_: "Aquí están los Trail Files que el Extract juntó durante las últimas 5 horas. <mark style="background:rgba(136, 49, 204, 0.2)">Pero comienza a aplicar los cambios únicamente a partir del SCN de nuestra foto</mark>".
