...
En la arquitectura [[Bases de Datos Multitenant|Oracle Multitenant]] <mark style="background:#fdbfff">solo existe un conjunto de *Online Redo Log Files* en el nivel de la *CDB* que se comparte con todas las *PDBs* dentro de la *CDB*</mark>. Las *PDBs* no cuentan con *Online Redo Log Files* propios.
